...
1. **Vagrant Cloud by HashiCorp**:
   - [[https://app.vagrantup.com/][Vagrant Cloud]]

2. **Bento**:
   - [[https://github.com/chef/bento][Bento on GitHub]]

3. **Boxcutter**:
   - [[https://github.com/boxcutter][Boxcutter on GitHub]]

4. **Veewee**:
   - [[https://github.com/jedi4ever/veewee][Veewee on GitHub]]

5. **Packer Templates by Parallels**:
   - [[https://github.com/Parallels/vagrant-parallels][Parallels Packer Templates]]

6. **osboxes.org**:
   - [[https://www.osboxes.org/][osboxes.org]]

7. **Vagrant Setup by Jeff Geerling**:
   - [[https://github.com/geerlingguy/packer-boxes][Jeff Geerling's Vagrant Setup on GitHub]]

8. **Vagrantbox.es**:
   - [[https://www.vagrantbox.es/][Vagrantbox.es]]
